...
trait TraitBlocoII
{
    protected function blocoII($y)
    {
        ...
        if ($this->tpEmis == 9) {
            ...
            $aFont = ['font' => $this->fontePadrao, 'size' => $this->fontSizeDefaultSub, 'style' => 'B'];
            $y1 = $this->pdf->textBox(
                $this->margem,
                $y,
                $this->wPrint,
            ...
            if (!$this->infProt) {
                ...
                $aFont = ['font' => $this->fontePadrao, 'size' => $this->fontSizeDefaultSub, 'style' => 'I'];
                $this->pdf->textBox(
                    $this->margem,
                    $y + $y1 + $y2,
                    $this->wPrint,
        ...
        $this->pdf->dashedHLine($this->margem, $this->bloco2H + $y, $this->wPrint, 0.8, 30);
