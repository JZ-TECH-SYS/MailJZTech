...
class Danfce extends DaCommon
{
    ...
    protected $hLinha = 3;
    protected $aFontTit = ['font' => 'monospace', 'size' => 15, 'style' => 'B'];
    protected $aFontTex = ['font' => 'monospace', 'size' => 12, 'style' => 'B'];
    protected $via = "Via Consumidor";
    protected $offline_double = true;
    protected $canceled = false;
    protected $submessage = null;

    protected $fontSizeDefault = 15;
    protected $fontSizeDefaultSub = 12;

    protected $bloco1H = 30.0; //cabeçalho
    protected $bloco2H = 15.0; //informação fiscal

    protected $bloco3H = 20.0; //itens
    protected $bloco4H = 20.0; //totais
    protected $bloco5H = 10.0; //formas de pagamento
    ...
    {
        if (!in_array($font, ['times', 'arial','monospace'])) {
