...
use src\handlers\NFEs\UtilsNF\XMLBackupHelper;
...
class ReEnviarNota
{
    ...
    public static function gerar(array $pedido): string
    {
        ...
        try {
            ...
            $nfantiga = $pedido['nf'] ?? null;
            if (!$nfantiga) {
                throw new \Exception("Nota fiscal não informado. Não é possível reenviar.");
            }

            XMLBackupHelper::registrar($nfantiga);
            ...
            ], $pedido['idempresa'], $pedido['idpedidovenda'], true);
