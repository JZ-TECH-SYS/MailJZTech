...
- **API:** http://localhost:8050 (se rodar no Docker)
- **phpMyAdmin:** http://localhost:8090
- **Web:** http://localhost/MailJZTech (se rodar local no Laragon)
...
Este projeto tem um script helper: **`docker.ps1`** (Windows) e **`docker.sh`** (Linux/Mac)
...
- ✅ Cada projeto tem seu próprio **database** (`mailjztech`, `clickexpress`, etc)
